...
async function getSongs(folder){
    ...
    Array.from(document.querySelector(".songList").getElementsByTagName("li")).forEach(e=>{
        e.addEventListener("click",element=>{
            ...
            playMusic(e.querySelector(".info").firstElementChild.innerHTML,false);
        })
    })
    return songs;
...
async function main(){
    songs = await getSongs("songs/silent");
    ...
    currentSong.addEventListener("timeupdate", () => {
        ...
        document.querySelector(".move").style.width = (currentSong.currentTime / currentSong.duration) * 100 + "%";
    })
